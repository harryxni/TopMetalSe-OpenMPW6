...
C {devices/lab_pin.sym} -1030 410 0 0 {name=l2 sig_type=std_logic lab=AMP_IN}
C {devices/lab_pin.sym} -880 410 2 0 {name=l4 sig_type=std_logic lab=gring}
C {devices/capa.sym} -1000 410 1 1 {name=C1
m=1
value=3f
footprint=1206
